...
| `CrossbowTower3D/ModelRoot/ReplaceableVisual_CrossbowTower` | Arbalet Kulesi `.glb` | Taban merkezi | 2–3 m footprint | `Idle`, `Fire` isteğe bağlı | Mavi/gri ağır mekanizma | `RotatingHead` ve `FirePoint` korunmalı |
| `IceTower3D/ModelRoot/ReplaceableVisual_IceTower` | Buz Kulesi `.glb` | Taban merkezi | 2–3 m footprint | `Idle`, `Fire` isteğe bağlı | Cyan/buz materyal parametresi | `RotatingHead` ve `FirePoint` korunmalı |
| `BombTower3D/ModelRoot/ReplaceableVisual_BombTower` | Bomba Kulesi `.glb` | Taban merkezi | 2–3 m footprint | `Idle`, `Fire` isteğe bağlı | Turuncu/koyu metal vurgu | `RotatingHead` ve `FirePoint` korunmalı |
